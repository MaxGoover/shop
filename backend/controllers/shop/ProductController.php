...
class ProductController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($form->load(Yii::$app->request->post()) && $form->validate()) {
            try {
                $product = $this->_manageService->create($form);
    ...
    {
        try {
            $this->_manageService->removePhoto($id, $photo_id);
        } catch (\DomainException $e) {
            Yii::$app->session->setFlash('error', $e->getMessage());
        }
    ...
    {
        $this->_manageService->movePhotoUp($id, $photo_id);
        return $this->redirect(['view', 'id' => $id, '#' => 'photos']);
    }
    ...
    {
        $this->_manageService->movePhotoDown($id, $photo_id);
        return $this->redirect(['view', 'id' => $id, '#' => 'photos']);
    }
    ...
    public function actionPrice($id)
    {
        ...
        if ($form->load(Yii::$app->request->post()) && $form->validate()) {
            try {
                $this->_manageService->changePrice($product->id, $form);
                return $this->redirect(['view', 'id' => $product->id]);
            } catch (\DomainException $e) {
                Yii::$app->errorHandler->logException($e);
                Yii::$app->session->setFlash('error', $e->getMessage());
    ...
    public function actionQuantity($id)
    {
        ...
        if ($form->load(Yii::$app->request->post()) && $form->validate()) {
            try {
                $this->_manageService->changeQuantity($product->id, $form);
                return $this->redirect(['view', 'id' => $product->id]);
            } catch (\DomainException $e) {
                Yii::$app->errorHandler->logException($e);
                Yii::$app->session->setFlash('error', $e->getMessage());
    ...
    public function actionUpdate($id)
    {
        ...
        if ($form->load(Yii::$app->request->post()) && $form->validate()) {
            try {
                $this->_manageService->edit($product->id, $form);
                return $this->redirect(['view', 'id' => $product->id]);
            } catch (\DomainException $e) {
                Yii::$app->errorHandler->logException($e);
                Yii::$app->session->setFlash('error', $e->getMessage());
    ...
    public function actionView($id)
    {
        ...
        if ($photosForm->load(Yii::$app->request->post()) && $photosForm->validate()) {
            try {
                $this->_manageService->addPhotos($product->id, $photosForm);
                return $this->redirect(['view', 'id' => $product->id]);
            } catch (\DomainException $e) {
                Yii::$app->errorHandler->logException($e);
                Yii::$app->session->setFlash('error', $e->getMessage());
